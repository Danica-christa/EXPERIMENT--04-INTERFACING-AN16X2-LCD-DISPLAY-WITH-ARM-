...
int main(void)
{
  ...
  Lcd_PortType ports[] = { GPIOA, GPIOA, GPIOA, GPIOA };
    ...
    Lcd_cursor(&lcd, 0,1);
    Lcd_string(&lcd, "Danica");
    Lcd_cursor(&lcd, 1,1);
        Lcd_string(&lcd, "212223240022");
...
![Screenshot 2024-10-16 155926](https://github.com/user-attachments/assets/4dbef0ca-2aca-407b-9a85-968a918e6b8e)

![Screenshot 2024-10-05 140436](https://github.com/user-attachments/assets/1a00f4fe-6482-4827-96e0-cf9315e96a48)

 
 ## CIRCUIT DIAGRAM (EXPORT THE GRAPHICS TO PDF AND ADD THE SCREEN SHOT HERE): 

 ![Screenshot 2024-10-16 160054](https://github.com/user-attachments/assets/8fe19ec8-902a-427f-a486-d78478171b22)
